...
contract(
  "Bridge - [create a deposit proposal (voteProposal) with relayerThreshold = 1]",
  async (accounts) => {
    ...
    beforeEach(async () => {
      ...
      dataHash = Ethers.utils.keccak256(
        DestinationERC20HandlerInstance.address + data.substr(2)
      );
    });
