...
contract("GenericHandler - [deposit]", async (accounts) => {
  ...
  beforeEach(async () => {
    await Promise.all([
      ...
      WithDepositerContract.new().then(
        (instance) => (WithDepositerInstance = instance)
      ),
    ...
    initialResourceIDs = [
      Helpers.createResourceID(ChainAssetInstance.address, domainID),
    ...
    await Promise.all([
      ...
      BridgeInstance.adminSetGenericResource(
        ...
        initialDepositFunctionDepositerOffsets[1],
      ...
      BridgeInstance.adminSetGenericResource(
        ...
        initialDepositFunctionDepositerOffsets[2],
      ...
      BridgeInstance.adminSetGenericResource(
        ...
        initialDepositFunctionDepositerOffsets[3],
      ...
      BridgeInstance.adminSetGenericResource(
        ...
        initialDepositFunctionDepositerOffsets[4],
      ...
      BridgeInstance.adminSetGenericResource(
        ...
        initialDepositFunctionDepositerOffsets[5],
      ...
      BridgeInstance.adminSetGenericResource(
        ...
        initialDepositFunctionSignatures[6],
        initialDepositFunctionDepositerOffsets[6],
        initialExecuteFunctionSignatures[6]
      ),
    ]);
  ...
  it("deposit can be made successfully", async () => {
    await TruffleAssert.passes(
      BridgeInstance.deposit(domainID, initialResourceIDs[0], depositData, {
